...
// import { ChevronRight, Play, Code, Send, Loader, CheckCircle, AlertCircle } from 'lucide-react';

// // 📦 Context לניהול משתמשים
...
//     { id: 1, name: 'עינת כהן', email: 'einat@email.com', courses: [1, 2] },
//     { id: 2, name: 'שירה לביא', email: 'shira@email.com', courses: [1, 3] },
//     { id: 3, name: 'רונית מישל', email: 'ronit@email.com', courses: [2, 3] },
//     { id: 4, name: 'דנה אהרונסקי', email: 'dana@email.com', courses: [1] }
//   ]);
...
//           <p className="text-sm text-gray-600 text-center mb-4">בחרי את שמך כדי להתחיל:</p>
//           {users.map(user => (
//             <button
//               key={user.id}
...
// // 📚 דף הקורסים
// const DashboardPage = ({ user, onSelectCourse, courses }) => {
...
//         <div className="mb-8">
//           <h1 className="text-4xl font-bold text-gray-800 mb-2">ברוכה בחזרה, {user.name}! 👋</h1>
...
//     setLoading(true);
//     try {
//       // סימולציה של בדיקה עם AI (בפועל, תשלחו לשרת)
//       await new Promise(r => setTimeout(r, 2000));

//       const mockFeedback = {
//         completion_percentage: Math.floor(Math.random() * 30) + 70,
//         feedback: 'הקוד שלך טוב! יש כמה דברים שניתן לשפר.',
//         suggestions: ['השתמשו בפונקציות יותר בכדי למנוע חזרה על קוד', 'הוסיפו הערות להבהרת הלוגיקה'],
//         grade: Math.floor(Math.random() * 25) + 75,
//         comments: 'הצעה: נסו להשתמש ב-comments בקוד שלכם'
//       };

//       setFeedback(mockFeedback);
//     } catch (error) {
//       alert('שגיאה בבדיקת הקוד');
//     } finally {
//       setLoading(false);
//     }
//   };
...
//     // שליחת מייל סופי (בפועל יהיה בשרת)
//     alert(`✅ המטלה הוגשה בהצלחה!\n\nציון: ${feedback.grade}/100\n\nמייל יישלח ל${user.email}`);
//     setSubmitted(true);
//   };
...
//           <h3 className="text-xl font-bold text-gray-700 mb-2">{chapter.assignment.title}</h3>
...
//             >
//               {loading ? <Loader className="w-5 h-5 animate-spin" /> : <Code className="w-5 h-5" />}
//               בדיקה עם AI
//             </button>
...
//               <div>
//                 <h2 className="text-2xl font-bold text-gray-800 mb-4">✨ משוב ההערכה</h2>
//                 <div className="bg-white rounded-lg p-4 mb-4">
//                   <div className="flex items-center gap-4 mb-4">
//                     <div>
//                       <p className="text-sm text-gray-600">אחוז השלמה</p>
//                       <p className="text-3xl font-bold text-green-600">{feedback.completion_percentage}%</p>
//                     </div>
//                     <div>
//                       <p className="text-sm text-gray-600">ציון סופי</p>
//                       <p className="text-3xl font-bold text-blue-600">{feedback.grade}/100</p>
//                     </div>
//                   </div>
//                 </div>
...
//                 <div className="bg-white rounded-lg p-4 mb-4">
//                   <h3 className="font-bold text-gray-800 mb-2">💡 הצעות לשיפור:</h3>
...
//             </h3>
//             <p className="text-green-700 mt-2">מייל אישור יישלח לכתובת שלך בעוד כמה רגעים.</p>
//           </div>
//         )}
//       </div>
//     </div>
...
//     {
//       id: 1,
//       name: 'HTML & CSS - יסודות',
//       description: 'קורס לימוד HTML ו-CSS מ-0 ל-100',
//       chapters: [
//         {
//           id: 1,
//           title: 'מבוא ל-HTML',
//           description: 'הכירו עם תגיות HTML, מבנה דף ואלמנטים בסיסיים',
//           videos: [
//             { title: 'מה זה HTML?', url: 'https://www.youtube.com/embed/WBuVAVLKm34' },
//             { title: 'תגיות בסיסיות', url: 'https://www.youtube.com/embed/OXGznpKZ_sA' }
//           ],
//           assignment: {
//             title: 'בנו דף HTML ראשון',
//             description: 'צרו דף HTML המכיל: כותרת (h1), פסקה (p), רשימה (ul/li) ותמונה'
//           }
//         }
//       ]
//     }
...
//         <DashboardPage user={currentUser} onSelectCourse={handleSelectCourse} courses={courses} />
//       )}
//       {currentPage === 'course' && (
//         <CoursePage user={currentUser} course={selectedCourse} onSelectChapter={handleSelectChapter} onBack={handleBack} courses={courses} />
//       )}
//       {currentPage === 'chapter' && (
//         <ChapterPage user={currentUser} chapter={selectedChapter} course={selectedCourse} onBack={handleBack} />
//       )}
//     </div>
//   );
// }
